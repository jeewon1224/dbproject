//  // cutting text of each boxes
//  $(function(){
//   let designBox = $('.deWeBox');

//   for(let i=0; i<designBox.length; i++){
//     let cutTxt = designBox.eq(i).find(".cutTxt").text(); // text() (지정된 요소의) 텍스트를 읽는 기능
    
//     $(window).resize(function(){
//       let winWidth = $(window).width();
//       if(winWidth < 800){
//         designBox.eq(i).find('.cutTxt').text(cutTxt.substr(0,20) + ' ...');
        
//       }else{
//         designBox.eq(i).find('.cutTxt').text(cutTxt.substr(0,50) + ' ...');
